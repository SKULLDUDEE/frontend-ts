...
export default function ChatBot() {
  ...
  const [design, setDesign] = useState({
    ...
    customMessages: ['Hi', 'How can I help you?'],
  ...
  const handleSend = async () => {
    ...
    try {
      if (!ticketId) {
        const ticketResp = await fetch(`${import.meta.env.VITE_API_URL}/tickets/create-or-get`, {
          method: 'POST',
        ...
        const response = await fetch(`${import.meta.env.VITE_API_URL}/tickets/${ticketId}/messages`, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
  ...
  const handleDetailSubmit = async () => {
    try {
      const userResp = await fetch(`${import.meta.env.VITE_API_URL}/tickets/check-user`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        ...
        <div className="chat-window" style={{ backgroundColor: design.backgroundColor }}>
          ...
          {showForm && (
            <div className="detail-form">
              <div className="form-title">Introduction Yourself</div>
