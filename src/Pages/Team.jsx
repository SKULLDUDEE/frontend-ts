...
const Team = () => {
      ...
      try {
        ...
        if (user.teamId) {
          ...
          const memberDetailsPromises = teamData.map(async (member) => {
            try {
              const memberRes = await fetch(`${import.meta.env.VITE_API_URL}/users/getUserDetails/${member.userId._id}`, {
                method: 'GET',
                credentials: 'include',
                headers: {
                  'Content-Type': 'application/json',
  ...
  const handleAddMember = async () => {
      try {
        ...
        const res = await fetch(`${import.meta.env.VITE_API_URL}/team/addMember`, {
          method: 'POST',
          credentials: 'include',
          headers: {
            'Content-Type': 'application/json',
    ...
    const handleConfirmDelete = async () => {
      ...
      try {
        const res = await fetch(`${import.meta.env.VITE_API_URL}/team/removeMember/${user.teamId}`, {
          method: 'DELETE',
          credentials: 'include',
          headers: {
            'Content-Type': 'application/json',
            ...
            <button
              ...
              onClick={async () => {
                ...
                const res = await fetch(
                  `${import.meta.env.VITE_API_URL}/team/updateMemberRole/${user.teamId}`,
                  {
                    method: 'PUT',
                    credentials: 'include',
                    headers: {
